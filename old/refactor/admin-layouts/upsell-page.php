<div id="wppr-admin">
	...
	<?php
	wppr_admin_template( 'header-layout' );
	?>
	...
	<div class="pro-feature">
		...
		<div class="pro-feature-image"><img src="<?php echo WPPR_URL; ?>/img/wppr-amazon-integration-and-support.jpg">
		</div>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
	...
	<div class="pro-feature">
		...
		<div class="pro-feature-image"><img src="<?php echo WPPR_URL; ?>/img/wppr-shortcodes.jpg"></div>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
	...
	<div class="pro-feature">
		...
		<div class="pro-feature-image"><img src="<?php echo WPPR_URL; ?>/img/wppr-review-comparison.jpg"></div>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
	...
	<div class="pro-feature">
		...
		<div class="pro-feature-image"><img src="<?php echo WPPR_URL; ?>/img/wppr-import.jpg"></div>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
</div>
