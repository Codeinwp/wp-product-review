...
(function ($, w) {
    ...
    function initAll() 
    {
        ...
        $(document).on(
            'widget-updated widget-added', function (e, widget) {
                initEvents(widget);
            }
        );
    ...
    function initEvents(widget) 
    {
        if(widget) {
            ...
            widget.find('.wppr-post-types').on(
            ...
            $.ajax(
                {
                    ...
                    success : function (data) {
                        if(data.data.categories) {
                            ...
                            $.each(
                                data.data.categories, function (slug, name) {
    ...
    $(document).on(
        'widget-updated widget-added', function (e, w) {
    ...
    {
        var widget = $("#" + widgetID);
        widget.find("input.wppr-stylestyle").on(
            "click", function (e) {
                toggleCustomFields(false, widgetID);
            }
        );
        widget.find("label.wppr-stylestyle").hover(
            function (e) {
